      ...
      <Card className="p-6">
        <form onSubmit={e => { e.preventDefault(); mut.mutate(); }} className="space-y-5">
          ...
          <div className="grid sm:grid-cols-3 gap-4">
            ...
            <Field label="Prix de vente HT (€)"><Input type="number" step="0.01" value={form.price} onChange={set("price")} /></Field>
            <Field label="Coût d'achat (€)"><Input type="number" step="0.01" value={form.cost} onChange={set("cost")} /></Field>
