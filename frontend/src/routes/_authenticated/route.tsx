          ...
          <div className="ml-auto flex items-center gap-2">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" size="sm" className="text-white hover:bg-white/15 hover:text-white gap-2">
                  <span className="size-7 rounded-full bg-[var(--sidebar-accent)] text-white flex items-center justify-center text-xs font-medium">
                    {initials}
                  </span>
...
/** Exposed so section landing pages (pos.tsx, billing.index.tsx, …) can render
 *  their own SectionHero quick-links using the same source of truth as the header. */
export { NAV };
