        ...
        <Card className="p-6 lg:col-span-2">
          ...
          <form onSubmit={e => { e.preventDefault(); update.mutate(); }} className="space-y-4">
            ...
            <div className="grid sm:grid-cols-3 gap-4">
              ...
              <F label="Prix HT (FCFA)"><Input type="number" step="1" value={form.price ?? 0} onChange={set("price")} /></F>
              <F label="Coût (FCFA)"><Input type="number" step="1" value={form.cost ?? 0} onChange={set("cost")} /></F>
